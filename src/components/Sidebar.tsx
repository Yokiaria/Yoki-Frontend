    ...
    <div className="flex flex-col h-full py-8 px-4 bg-primary dark:bg-on-background border-r border-outline-variant/10 text-white select-none">
      ...
      <div className="mb-8 px-2">
        <button
          ...
          className="w-full bg-white/10 hover:bg-white/20 text-white font-semibold py-3.5 px-4 rounded-xl border border-white/20 transition-all flex items-center justify-center gap-2 shadow-sm cursor-pointer active:scale-[0.98]"
        >
