...
export default function CheckInOnline({ setActiveTab, hotel, user }: CheckInOnlineProps) {
    ...
    return (
        <main
            className="max-w-7xl mx-auto px-4 md:px-8 py-8 text-left font-sans flex-grow w-full pb-32 grid grid-cols-1 lg:grid-cols-12 gap-8"
